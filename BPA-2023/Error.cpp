...
namespace Error
{
	...
	*/
	...
	ERROR errors[ERROR_MAX_ENTRY] =
	{
		...
		ERROR_ENTRY(512,"[Cемантическая] Недопустимое сочитание литерала и типа данных"),
		ERROR_ENTRY(513,"[Cемантическая] Попытка изменить значение константы"),
		ERROR_ENTRY(514,"[Cемантическая] Попытка использования переменной без значения"),
		...
		ERROR_ENTRY(607,"[Cинтаксическая] Ошибка в описании константы"),
